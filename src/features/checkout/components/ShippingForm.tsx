...
import {shippingAddressValues} from '../schemas/checkout.schemas'
import {
  faHome,
  faCity,
  faMapMarkerAlt,
        ...
        <div>
          ...
          <div className="relative">
            ...
            <textarea
              id="details"
              rows={3}
              className="w-full px-4 py-3.5 pl-14 border-2 rounded-xl focus:outline-none transition-all border-gray-200"
